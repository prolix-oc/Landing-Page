                              ...
                              <AnimatePresence>
                                {openDropdown === card.path && (
                                  ...
                                  >
                                    {card.thumbnailUrl && (
                                      <motion.a
                                        href={card.thumbnailUrl}
                                        download
                                        className="group/item flex items-center gap-3 px-4 py-3 hover:bg-blue-600/20 transition-colors text-white text-sm font-medium border-b border-gray-700"
                                        whileHover={{ x: 4 }}
                                      >
                                    ...
                                    <motion.a
                                      href={card.jsonUrl}
                                      download
                                      className="group/item flex items-center gap-3 px-4 py-3 hover:bg-blue-600/20 transition-colors text-white text-sm font-medium"
                                      whileHover={{ x: 4 }}
                                    >
