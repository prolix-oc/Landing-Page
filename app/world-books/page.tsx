                              ...
                              >
                                ...
                                <div className="flex gap-2">
                                  <motion.button
                                    ...
                                    className="flex-1 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition-colors text-center shadow-lg shadow-green-500/30 hover:shadow-green-500/50"
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex gap-2">
                                  <motion.button
                                    onClick={() => downloadFile(file.downloadUrl, file.name)}
                                    className="flex-1 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg transition-colors text-center shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50"
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                  >
                                    Download
